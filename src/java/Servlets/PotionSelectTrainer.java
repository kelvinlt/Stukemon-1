 ...
 * @author Alfredo
 */
public class PotionSelectTrainer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PotionSelectTrainer</title>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PotionSelectTrainer at " + request.getContextPath() + "</h1>");
            out.println("<form action=\"GetPotionsTrainer\" method=\"GET\">");
