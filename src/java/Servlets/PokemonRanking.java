 ...
 * @author Alfredo
 */
public class PokemonRanking extends HttpServlet {
    @EJB
    StukemonEJB miEjb;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowPokemon</title>");
            ...
            out.println("<h1>Servlet ShowPokemon at " + request.getContextPath() + "</h1>");
            ...
            for (Pokemon currentPoke : allPokemon) {
                ...
                out.println("<label>" + currentPoke.getName() + ", LVL "+currentPoke.getLevel()+"</label>");
                out.println("</div>");
                out.println("<div class=\"col-lg-4\">");
                //out.println(currentTrainer.getName());
                //out.println(currentPoke.toString());
                out.println("<label>" + currentPoke.getTrainer().getName() + "</label>");
                out.println("</div>");
                out.println("<div class=\"col-lg-4\">");
                out.println("<label> HP: " + currentPoke.getLife()+ "</label>");
                //out.println(currentTrainer.getName());
                //out.println(currentPoke.toString());
